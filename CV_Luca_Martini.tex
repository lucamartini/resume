...
\begin{europasscv}
	...
	\ecvitem{}{As a JavaScript full-stack developer, I have been hired to migrate the current LAMP stack to a modern architecture, and to develop solutions for the main business logics. 
		\begin{ecvitemize}
			\item I am currently using React and Material-UI for the front-end part, and Node.js for the back-end. Communication between client and servers is pursued via REST and GraphQL APIs.
			\item I am developing internal micro-services for the back-end functionalities, that communicate through the gRPC language specifications. Furthermore, I am using AWS services (S3, Lambda, EC2) to lighten the NWG server workload
