...
\begin{europasscv}
	...
	\ecvbigitem{Current position}{JavaScript Full-stack developer in NWG Energia S.p.a. Società Benefit}
	...
	\ecvitem{}{
	  ...
	  I'm coding primarily in JavaScript but I also touch PHP and Python when needed.
		\begin{ecvitemize}
			\item I'm responsible of the main NWG web app (called "Vip Office"), which serves thousands of authenticated clients with different profiles.
			...
			\item I develop internal micro-services for the back-end functionalities, that communicate through the gRPC protocol. Data being stored in MySQL and Redis.
