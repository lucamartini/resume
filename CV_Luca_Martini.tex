...
\ecvpictureleft[scale=0.4]{faccia.jpg}
...
\begin{europasscv}
	...
	\ecvtitle{from 2018/03 to today}{JavaScript Full-stack developer}
	\ecvitem{}{NWG Energia S.p.a. Società Benefit}	
	\ecvitem{}{As a JavaScript full-stack developer, I have been hired to migrate the current LAMP stack to a modern architecture, and to find solutions for the company business logic. 
		\begin{ecvitemize}
			\item I manage the main web app of NWG (called "vipoffice"), which serves thousands of authenticated clients with different profiles.
			\item I am currently using React and Material-UI for the front-end part, and Node.js for the back-end. Communication between clients and servers is pursued via REST and GraphQL APIs.
			\item I am also working with React Native and Expo to publish NWG apps into the App Store and Google Play
			\item I am developing internal micro-services for the back-end functionalities, that communicate through the gRPC language specifications. Furthermore, I am using AWS services (S3, Lambda, EC2, Amplify) to lighten the NWG server workload
			\item I'm using different solutions for storing and retrieving data: MySQL databases, and noSQL: Redis and ElasticSearch.
			\item I develop in a continuous integration environment, with unit and integration tests (with jest), E2E tests (with Cypress) and load tests (with Artillery).
			\item My preferred way of coding is TDD.
			\item The team I'm in, follows the Agile methodology to maximize our workload profit.
		\end{ecvitemize}
	}

	\ecvitem{}{\ecvhighlight{Sectors:} JavaScript Software Developing}
	...
	\ecvitem{\textcolor{ecvsectioncolor}{Conferences}}{
		\begin{ecvitemize}
			\item Speaker in 7 international physics conferences: [La Thuile 2010], [Frascati 2010], [Vienna 2011], [Parigi 2011], [La Thuile 2012], [La Biodola 2012], [Kolymvari 2013]
		\end{ecvitemize}
	}	
