...
\ecvaddress{Via XXVII Aprile, 87/H, Pescia, 51017, PT, Italy}
\ecvmobile{+39 333 3766759}
\ecvemail{luca.martini82@gmail.com}
\ecvdateofbirth{1982/05/03}
\ecvnationality{Italian}
\ecvgender{Male}

\ecvpictureleft[scale=0.05]{faccia.jpg}
...
\begin{europasscv}
  ...
  \ecvbigitem{Current position}{JavaScipt Full-stack developer in NWG Energia S.p.a. Società Benefit}

  \ecvsection{Work Experience}

  \ecvtitle{from 2018/03 to today}{Software developer / architect}
  \ecvitem{}{NWG Energia S.p.a. Società Benefit}
  \ecvitem{}{
    ...
    \item My preferred way of coding is TDD.
    \item The team I'm in, follows the Agile methodology to maximize our workload profit.
    \end{ecvitemize}
  }

  \ecvitem{}{\ecvhighlight{Sectors:} JavaScript Software Developing, Cloud Architect}

  \ecvtitle{from 2015/10 to 2018/03}{Software developer / designer}
  \ecvitem{}{Cynny}
  ...
  \ecvitem{}{Physics post doc.~on the development of an algorithm for the reconstruction of tracks at the first trigger level in CMS at HL-LHC (CERN)
  ...
  \ecvitem{}{University of Pisa \& INFN Pisa}
  \ecvitem{}{Physics post doc.~on L1 trigger software and hardware development for High Luminosity-LHC for the CMS experiment at CERN (CH).
  ...
  \ecvitem{\textcolor{ecvsectioncolor}{Job-related skills}}{
    ...
    \item Software development and design, \CC~(8 years) and JavaScript~(6 years) languages, Test-Driven Development
    \end{ecvitemize}
  }
  ...
  \ecvitem{\textcolor{ecvsectioncolor}{Certifications}}{
    \begin{ecvitemize}
